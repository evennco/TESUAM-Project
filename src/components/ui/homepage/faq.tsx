    ...
    return (
        <section className="bg-foundationcolorwhite dark:bg-foundationcolorwhite">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                ...
                <div className="grid pt-8 text-left border-t border-foundationcolorblack dark:border-foundationcolorblack md:gap-16 md:grid-cols-2">
                    {questionfaqs.map((faq, index) => (
                        <div key={index} className={`mb-10 ${index !== questionfaqs.length ? 'border-b border-foundationcolorblack dark:border-foundationcolorblack pb-4' : ''}`}>
                            <h3
