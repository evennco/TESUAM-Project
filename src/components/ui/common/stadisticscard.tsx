...
const StadisticsCard = ({ value, text }: StadisticsCardProps) => {
    return (
        <div className="py-10 px-9 hover:border-2 hover:bg-[#D3934633] hover:border-foundationcoloryellow1 rounded-lg transition duration-300">
            <div className="text-4xl font-bold text-foundationcoloryellow1 mb-2"><p className="text-6xl">+<CountUp start={0} end={value} duration={2.5}></CountUp></p></div>
